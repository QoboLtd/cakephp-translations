...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        <?= $this->Form->control('content', ['type' => 'textarea', 'label' => $language->name, 'placeholder' => __d('Qobo/Translations', 'Translation'), 'id' => 'translation_' . $language->code, 'required' => false]); ?>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
