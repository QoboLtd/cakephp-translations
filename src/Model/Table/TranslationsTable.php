...
class TranslationsTable extends Table
{
     ...
     * @return \Qobo\Translations\Model\Entity\Translation|array|null single record or list of saved translations
     */
    public function getTranslations(string $modelName, string $recordId, array $options = [])
    {
        ...
        if (!empty($options['toEntity'])) {
            /**
             * @var \Qobo\Translations\Model\Entity\Translation $entity
             */
            $entity = $query->first();
    ...
    {
        /**
         * @var \Qobo\Translations\Model\Entity\Translation $translationEntity
         */
