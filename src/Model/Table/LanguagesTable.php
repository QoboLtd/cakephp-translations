...
class LanguagesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('Translations', [
            ...
            'className' => 'Qobo/Translations.Translations'
        ]);
    }
     ...
     * @return \Qobo\Translations\Model\Entity\Language
     */
    public function addOrRestore(array $data): \Qobo\Translations\Model\Entity\Language
    {
        if (empty($data['code'])) {
        ...
        /**
         * @var \Qobo\Translations\Model\Entity\Language $result
         */
